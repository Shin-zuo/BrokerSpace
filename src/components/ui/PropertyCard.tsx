        ...
        <button 
          onClick={async (e) => {
            ...
            const shareData = {
              ...
              text: `Check out this property on BrokerSpace: ${property.title}`,
              url: shareUrl,
            };
            try {
              if (navigator.share) {
          ...
          className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl font-medium transition-colors cursor-pointer text-slate-600 hover:bg-slate-50"
        >
